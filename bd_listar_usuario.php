...
try {
	...
	/* consulta preparada, para datos de un id determinado
	$id = 2;
	$por_id = $bd->prepare("select * from usuarios where codigo = $id");
	// $por_id->execute( array(':rol' => 0));
	echo "Usuario:  <br>";
	print "Nombre : " . $usu['nombre'] . "<br> Clave : " . $usu['clave'] . "<br> Rol : " . $usu['clave'] . "<br>";
 */
